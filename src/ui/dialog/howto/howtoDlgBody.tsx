...
const Page3 = () => {
    return (
        <>
            ...
            <HowtoPH2>픽 이후 변경</HowtoPH2>
            <img src={"/img/p3st1.png"} />
            <ul>
                <li>픽이 된 항목은 아래의 항목을 사용할 수 있습니다</li>
                <ul>
                    <li>수정: 픽 된 내용을 수정합니다</li>
                    <li>
                        삭제: 픽 내용을 삭제합니다 (현재 픽 개수가 차감되므로 다시 한 번 픽을 해야
                        합니다)
                    </li>
                    <li>협상: 해당 픽을 고른 시청자를 다시 불러와 협상을 벌일 수 있습니다</li>
                    <li>밴/언밴: 밴 페이즈가 되었을 때 해당 항목을 밴 처리 합니다</li>
                </ul>
            </ul>
        </>
    );
